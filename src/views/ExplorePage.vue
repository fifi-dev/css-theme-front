<template>
    <main class="pb-20">
            ...
            <div class="flex justify-between items-stretch mt-6">
                ...
                <div class="w-2/12 flex flex-wrap justify-between flex-col">
                    <div class=" border-b-2 pb-8">
                        ...
                        <div class=" h-32 overflow-y-scroll mb-3">
                            <p class="font-semibold mb-1">C Monochromatic</p>
                            <p>Spider-man</p>
                    ...
                    <div class="flex w-full justify-end items-center h-1/5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-arrow-right-circle ml-4" viewBox="0 0 16 16">
        ...
        <div class="community-theme">
            ...
            <MainButton :state="buttonStateNormal">Contribuer</MainButton>
...
.theme-visual{
    min-height: 250px;
    width: 100%;
    background: url('https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?q=80&w=2855&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
